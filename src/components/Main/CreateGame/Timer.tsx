...
import { CreateGameDuration } from "../../../types";
...
type CreateGameTimerProps = CreateGameProps;
        ...
        >
          <Box mt="16px">
            ...
            <Grid gap="8px" gridTemplateColumns="repeat(3, 1fr)">
              {(
                Object.entries(CREATE_GAME_DURATION_OPTIONS) as [
                  CreateGameDuration,
                  number
                ][]
                ...
                <TimeSelector
                  ...
                  label={label}
                  value={value}
                  isSelected={game.duration.text === label}
                  onClick={() => {
                    console.log("Value: ", value);
                    onSetGame((prev) => ({
                      ...prev,
                      duration: { text: label, value: 10 },
                    }));
                  }}
                >
                  <Text>{label}</Text>
